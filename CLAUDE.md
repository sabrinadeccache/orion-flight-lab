...
| **Documents** (`/documents`) | ✅ | ✅ `/documents/new` | ✅ `/documents/[id]/edit` | ✅ | Criação redireciona pra edição, onde dá pra enviar uma nova versão (upload) e baixar a versão atual (signed URL, botão "Baixar documento") |
